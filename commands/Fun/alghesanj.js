...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    const LoveEmbed = new Discord.MessageEmbed()
      ...
      .setTimestamp()
      .setColor('RANDOM')
      .addField(` میزان علاقه  **${Member.user.username}** به *${message.author.username}* <a:qer:914468879546347541>است <a:hehe:914470000092414012> **${alpha}%** `, `[${sanjesh}](${"https://dsc.gg/persian-caesar"})`)
