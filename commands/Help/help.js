    ...
    if (args[0]) {
      ...
      if (!args[0]) {
        let help = new MessageEmbed()
          ...
          .setFooter(`Message Guild ${message.guild.name} | Created By mr.sinre :)`, `https://cdn.discordapp.com/avatars/865630940361785345/d0c85fbbdb0ee9f105336a041904e7d8.png?size=4096`)
          .setColor("#2F3136")
