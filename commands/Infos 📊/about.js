...
let infoEmbed = new MessageEmbed()
      ...
      //.addField("🧮| Aliases Count", `<:reply_desgine:950701730675445790>** Bot Aliases Count Is: \`${(message.client.commands.aliases.size)}\`**`,true)
      //.addField(`📚| Category Count:`, `<:reply_desgine:950701730675445790>** Bot Category Count Is: \`${(message.client.commands.category.size)}\`**`,true)
      .setTimestamp()
