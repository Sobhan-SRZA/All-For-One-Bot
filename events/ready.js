...
try{
   client.logger(
      clc.blueBright(`Guild(s): `) + clc.greenBright(`${client.guilds.cache.size} Servers`) + `\n` +
      clc.blueBright(`Watching: `) + clc.greenBright(`${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0)} Members`) + `\n` +
